...
import { FaFacebook, FaTwitter, FaInstagram, FaLeaf, FaTruck, FaWarehouse, FaClock, FaArrowRight, FaCheckCircle } from "react-icons/fa";
...
export default function Home() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Secure, temperature-controlled storage for raw food, dairy and other products.",
      color: "from-amber-500 to-orange-600"
    },
    {
      icon: <FaClock className="text-3xl" />,
      title: "On Demand Healthy Food",
      description: "Delivering fresh, nutritious meals tailored to your needs with timely service.",
        ...
        <nav className="container mx-auto px-4 py-4">
          <div className="backdrop-blur-xl bg-white/80 border border-white/20 rounded-2xl shadow-lg px-6 py-3 flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-2 rounded-full font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300">
                Order Now
              </button>
            </div>
          ...
          {/* Mobile Menu */}
          {isMenuOpen && (
            <div className="md:hidden absolute top-full left-4 right-4 mt-2 backdrop-blur-xl bg-white/90 border border-white/20 rounded-2xl shadow-xl p-6 animate-fadeIn">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 group">
                Start Ordering
                <FaArrowRight className="inline ml-2 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="bg-white/20 backdrop-blur-sm text-white border-2 border-white/30 px-8 py-4 rounded-full font-bold text-lg hover:bg-white/30 transition-all duration-300">
                Learn More
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="relative bg-white rounded-3xl p-8 shadow-xl group-hover:shadow-2xl transition-all duration-500 border border-gray-100">
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${service.color} flex items-center justify-center text-white mb-6 transform group-hover:rotate-12 transition-transform duration-500`}>
                    {service.icon}
                  </div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">{service.title}</h3>
                  <p className="text-gray-600 mb-6">{service.description}</p>
                  <button className="flex items-center text-green-600 font-semibold group/btn">
                    Learn More
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div data-aos="fade-right">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-700">
                  We are dedicated to solving critical food-related issues, including food scarcity, the lack of healthy meals, and the ignorance surrounding healthy dieting.
                </p>
            ...
            {blogPosts.map((post, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <a
                    href="#"
                    className="inline-flex items-center text-green-600 font-semibold group/readmore"
                  >
                    Read Article
                    <FaArrowRight className="ml-2 transform group-hover/readmore:translate-x-1 transition-transform" />
                  </a>
                </div>
              </article>
            ))}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold py-4 rounded-xl hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300"
                >
                  Send Message
                </button>
              </form>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="text-gray-400">Nutrition Consult</li>
              </ul>
            </div>
